...
<body class="bg-black min-h-screen">
            ...
            <table class="min-w-full table-auto border border-gray-300 text-sm">
                ...
                <tbody>
                    ...
                    while ($data = mysqli_fetch_array($query)) {
                        ...
                        <a href='edit_artikel.php?id_artikel={$data['id_artikel']}' class='text-blue600 hover:underline'>Edit</a>
                        <a href='delete_artikel.php?id_artikel={$data['id_artikel']}'
                        onclick='return conirm(\"Yakin ingin menghapus?\")'
    ...
    <footer class="bg-blue-800 text-white text-center py-4 mt-10">
        &copy; <?php echo date('Y'); ?> | Created by DEDE WILLI
    </footer>
</body>
